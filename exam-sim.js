...
(function () {
  ...
  var KEY = "ds10804-exam-sim-v1";
  var DURATION_MIN = 180;

  /* משבצות המבחן, לפי ניתוח שאלוני 2024–2025 */
  var SLOTS = [
    { title: "שאלה 1 · סיבוכיות", cats: ["לולאות", "לולאות מקוננות", "מלכודות מבחן", "נוסחאות נסיגה", "סיבוכיות", "אסימפטוטיקה"] },
    { title: "שאלה 2 · רקורסיה", cats: ["רקורסיה", "קוד רקורסיבי"] },
    { title: "שאלה 3 · רשימות מקושרות", cats: ["רשימות מקושרות"] },
    { title: "שאלה 4 · עצים ו-BST", cats: ["עצים ו-BST"] },
    { title: "שאלה 5 · מחסנית ותור", cats: ["מחסנית ותור"] },
    { title: "שאלה 6 · ערימה", cats: ["ערימה"] },
    { title: "שאלה 7 · ערבול", cats: ["ערבול"] },
    { title: "שאלה 8 · מיונים", cats: ["מיונים", "קריאות ומיונים"] }
  ];
